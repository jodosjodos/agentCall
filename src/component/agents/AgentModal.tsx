  ...
  return (
    <AgentContainer $isLeft={isLeft} onClick={onclick} $theme={theme}>
      ...
      <Row className="justify-content-start py-2 gap-2">
        ...
        }} style={{ cursor: 'pointer' }} src="/editProfile.svg" alt="" className="" />
      </Row>
      <Row>
      ...
      <Row className="py-2 ">
        ...
        <Row className="gap-1">
          ...
          <Paragraph $theme={theme}>{currentMonth?agent.incomingCalls[currentMonth].numberOfCall:agent.totalIncomingCalls}</Paragraph>
        </Row>
      </Row>
      <Row className="py-2 ">
        ...
        <Row className="gap-1">
          ...
          <Paragraph $theme={theme}>{currentMonth?agent.finishedCalls[currentMonth].numberOfCall:agent.totalFinishedCalls}</Paragraph>
        </Row>
      </Row>
      {!isLeft && (
        <>

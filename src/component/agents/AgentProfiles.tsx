...
const Paragraph = styled.p<{ $theme: string,$border?:boolean }>`
  ...
  return (
    <>
      <AgentProfileContainer className="d-flex agent-profile">
        ...
        >
          <Controller setCurrentMonth={setCurrentMonth} selectedDate={selectedDate}  setSelectedDate={setSelectedDate}  currentYear={currentYear} setCurrentYear={setCurrentYear} currentMonth={currentMonth} selected={selectedAgent != null}></Controller>
          <GridContainer
              ...
              <OnGoingCall $theme={theme} className="p">
                ...
                <Row className="py-2">
                  <Row className="gap-2">
                    ...
                    <Paragraph $border={true} $theme={theme}>00:40:01</Paragraph>
                  </Row>
                </Row>
                <div className="d-flex flex-grow-1 gap-2">
                  ...
                  <OnGoingCallRow onClick={onPlayPause} style={{ cursor: 'pointer' }}
                   className="p-2">
                    <OnGoingCallRowParagraph>{isPlaying?"Stop listening":"Listen to call"}</OnGoingCallRowParagraph>
                    <img src={isPlaying?"/playing.svg":"/resume.svg"}></img>
                  </OnGoingCallRow>
                </div>
                <Row>

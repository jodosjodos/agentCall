...
function TopBar({ isSidebarOpened }: { isSidebarOpened: boolean }) {
  ...
  return (
    <>
      ...
      {activeTopBar == 3 && <ImportStep3 isSidebarOpened={isSidebarOpened} setActiveTopBar={setActiveTopBar}></ImportStep3>}

      {activeTopBar == 4 && <ImportStep4></ImportStep4>}

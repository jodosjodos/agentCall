...
export function KnowledgePage({
  ...
  const handleUploadKnowledge = async () => {
    if (file) {
      ...
      formdata.append("raw", "file data");
      await Knowledge.createNewKnowledge(formdata)
  ...
  const GetAllKnowledge = async () => {
    const results = await Knowledge.getAllKnowledge()
    countFileTypes(results.data.results);
  }
  ...
  return (
    <KnowledgeContainer>
            ...
            <div className="d-flex flex-column gap-4">
              ...
              >
                ...
                <div className="d-flex flex-column gap-0 align-items-center">
                  <p className="p-0 m-0">{Documents.length} documents</p>
      ...
      <CenteredModal
        ...
        onContinue={() => handleUploadKnowledge()}
      ></CenteredModal>
    </KnowledgeContainer>
  );
}
